...
\begin{tcolorbox}
\textbf{Example}\\
The base rate stands at 0\%. The borrower opens a new Trove by depositing 2 ETH and minting 4,000 LUSD. Being subject to a Liquidation Reserve of 200 LUSD and charged a 0.5\% fee on the remaining 3,800 LUSD, the borrower will obtain 3,781.09 LUSD, while incurring a debt of 4,000 LUSD (3,781.09 + 200 + 18.91). To close the Trove and fully retrieve the 2 ETH, the borrower needs to repay 3,800 LUSD as the Liquidation Reserve gets refunded.
\end{tcolorbox}
...
In most cases, Stability Providers and/or high-collateral Troves will have a financial incentive to trigger liquidations as fast as possible. To compensate for the gas costs of a liquidation even in times with high prices, Liquity pays the reserved 200 LUSD (see 3.1 Borrower operations) plus 0.5\% of the Trove’s collateral (ETH) to the liquidator.
\\
...
\begin{table}[hbt!]
  ...
  \begin{center}
    ...
    \thead{Trove} & \thead{Debt} & \thead{Coll. \\ ETH} & \thead{CR} & \thead{Debt \\ increase} & \thead{Coll. \\ increase} & \thead{New \\ debt} & \thead{New coll. \\ ETH} & \thead{New CR} & \thead{Net gain \\ USD} \\
     ...
     \hlineB{2.5}
      Total & $20000$ & $16.8$ & $17\%$ & $0.00$ & $0.00$ & $20000.00$ & $16.80$ & $17\%$ & $0.00$ \\
      \hline
    \end{tabular}
  \end{center}
\end{table}
