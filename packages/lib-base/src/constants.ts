 ...
 * @public
 */
export const ONEUSD_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link ONEUSD_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const ONEUSD_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const ONEUSD_MINIMUM_DEBT = ONEUSD_LIQUIDATION_RESERVE.add(ONEUSD_MINIMUM_NET_DEBT);
