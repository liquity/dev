...
const params = { depositCollateral: Decimal.from(20), borrowXBRL: XBRL_MINIMUM_NET_DEBT };
...
test("there's no smoke", async () => {
  ...
  expect(await findByText(/you can borrow xbrl by opening a trove/i)).toBeInTheDocument();
