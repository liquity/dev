...
export const LiquityLogo: React.FC<LiquityLogoProps> = ({ width, height, ...boxProps }) => (
  <Box sx={{ lineHeight: 0 }} {...boxProps}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 156 38" {...{ width, height }}>
      {liquityText}
      {liquityLogo}
    </svg>
  </Box>
...
export const LiquityLogoSmall: React.FC<LiquityLogoProps> = ({ width, height, ...boxProps }) => (
  <Box sx={{ lineHeight: 0 }} {...boxProps}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 38" {...{ width, height }}>
      {liquityLogo}
    </svg>
  </Box>
);
