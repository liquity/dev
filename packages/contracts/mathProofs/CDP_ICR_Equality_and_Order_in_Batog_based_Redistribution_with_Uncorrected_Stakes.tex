...
\begin{definition}[System Order]
  We define the order $n$ of a system of troves as the number of trove creations that are either the first one or immediately preceded by a liquidation. We usually denote a system of order $n$ by $\Gamma_n$.\\
\end{definition}
...
\begin{definition}[Equivalent system order evolution]
  Given two equivalent system of troves $\Gamma \equiv \Gamma'$ and a transformation for the first one $f$, we define an equivalent system order evolution $f'$ over $\Gamma'$ as the following sequence of events:
  \begin{itemize}
