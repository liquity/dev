...
\begin{itemize}
  ...
  \item Theorem \ref{result:4}. We consider a system transition $\Gamma_1 \rightarrow \Gamma_2$ triggered by the creation of a trove, followed by some more creations, up to a set of creations $N$, and then by a set of liquidations $P$, such that $|N|, |P| > 0$ and $N \cap P = \emptyset$. For any trove $i$ in $\Gamma_1$ and any trove $j$ in $N$ with $\gamma_i = \gamma_j$, the corrected stake approach maintains $\gamma_i = \gamma_j$ in $\Gamma_2$. \\
...
\bigskip
Now, a fresh trove is added, $j$, with collateral $c_j$.  Let the ICR of trove $j$ equal the ICR of an active first-order trove $i$.\\

Now, trove $k$ liquidates. Upon liquidation, the second-order trove $j$ and the first-order trove $i$ earn the following collateral rewards:
...
\begin{equation} \label{eq:14}
    c_j=k(c_\mathsmaller{i}+x_\mathsmaller{i})
\end{equation}
...
\begin{equation} \label{eq:15}
    k=\frac{d_\mathsmaller{j}}{d_\mathsmaller{i}+y_\mathsmaller{i}}
\end{equation}
...
\bigskip
We define the collateral and debt rewards earned by trove $j$ and trove $i$ in the reward event:
...
\begin{equation} 
    s_\mathsmaller{j}=\frac{k(c_\mathsmaller{i}+x_\mathsmaller{i})C_n}{C_n+X_n}
\end{equation}
...
\begin{equation} 
    s_\mathsmaller{j}=\frac{k(c_i+Hc_i)C_n}{C_n+HC_n}
\end{equation}
...
\begin{equation} 
    s_j=\frac{kc_i(C_n+HC_n)}{C_n+HC_n}
\end{equation}
...
\begin{equation} 
    \gamma_{j}'=\frac{c_\mathsmaller{j}+akc_\mathsmaller{i}}{d_\mathsmaller{j}+bkc_\mathsmaller{i}}
\end{equation}
...
\begin{equation} 
    \gamma_{j}'=\frac{k(c_\mathsmaller{i} + x_\mathsmaller{i}+ac_\mathsmaller{i})}{k(d_\mathsmaller{i}+y_\mathsmaller{i}+bc_\mathsmaller{i})}
\end{equation}
