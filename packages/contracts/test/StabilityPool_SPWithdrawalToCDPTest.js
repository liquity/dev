...
contract('StabilityPool - Withdrawal of Stability deposit to Trove - reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal to Trove", async () => {
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 18) })
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 18) })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 18) })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
    ...
    it("withdrawETHGainToTrove():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 18) })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 18) })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(1, 18) })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing LUSD", async () => {
      ...
      // 100 - (70 + 50) / 3
      assert.isAtMost(th.getDifference((await stabilityPool.getCompoundedLUSDDeposit(alice)).toString(), '60000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await stabilityPool.getCompoundedLUSDDeposit(bob)).toString(), '60000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await stabilityPool.getCompoundedLUSDDeposit(carol)).toString(), '60000000000000000000'), 1000)

      // (0.7 + 0.5) * 0.995 / 3
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, '398000000000000000'), 1000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, '398000000000000000'), 1000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, '398000000000000000'), 1000)
    })
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing LUSD", async () => {
      ...
      // Check depositors' compounded deposit and ETH Gain
      const txA = await stabilityPool.withdrawETHGainToTrove(alice, alice, { from: alice })
      const txB = await stabilityPool.withdrawETHGainToTrove(bob, bob,  { from: bob })
      const txC = await stabilityPool.withdrawETHGainToTrove(carol, carol,   { from: carol })
      ...
      // 100 - (50 + 60 + 70) / 3
      assert.isAtMost(th.getDifference((await stabilityPool.getCompoundedLUSDDeposit(alice)).toString(), '40000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await stabilityPool.getCompoundedLUSDDeposit(bob)).toString(), '40000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await stabilityPool.getCompoundedLUSDDeposit(carol)).toString(), '40000000000000000000'), 1000)

      // (0.7 + 0.6 + 0.5) * 0.995 / 3
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, '597000000000000000'), 1000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, '597000000000000000'), 1000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, '597000000000000000'), 1000)
    })
    ...
    it("withdrawETHGainToTrove(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, dec(300, 18), carol, carol, { from: carol, value: dec(2, 'ether') })
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 18) })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(1, 18) })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4, value: dec(1, 18) })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      */
      ...
      //await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(50, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawETHGainToTrove(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      */
      ...
      //await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(50, 18)), defaulter_4, defaulter_4, { from: defaulter_4 })
    ...
    it("withdrawETHGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 1 withdraws 'almost' up to a debt of 100 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 18) })
      ...
      // Defaulter 2 withdraws up to a debt of 80 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: '500000000000000000' })
    ...
    it("withdrawETHGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 2 withdraws up to a debt of 540 LUSD
    ...
    it("withdrawETHGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 1 and default 2 each withdraw 99.999999999 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 18) })
    ...
    it("withdrawETHGainToTrove(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: alice })
          ...
          // Defaulter 1 and default 2 withdraw 99.999999999 LUSD and 59.9999999994
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 18) })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
    ...
    */
    ...
    it("withdrawETHGainToTrove(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      for (account of depositors) {
        await borrowerOperations.openTrove(th._100pct, dec(1, 36), account, account, { from: account, value: dec(1, 27) })
    ...
    it("withdrawETHGainToTrove(): Tiny liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      // Defaulter opens trove with 50e-9 ETH and 50 LUSD. 200% ICR
      ...
      aliceExpectedLUSDDeposit = toBN('999999999999999975000000000000000000')
      bobExpectedLUSDDeposit = toBN('999999999999999975000000000000000000')
