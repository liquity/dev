...
contract('StabilityPool - STBL Rewards', async accounts => {
  ...
  describe("STBL Rewards", async () => {
    ...
    it("withdrawFromSP(): Several deposits of 100 LUSD span one scale factor change. Depositors withdraw correct STBL gains", async () => {
    ...
    it("withdrawFromSP(): Several deposits of 10k LUSD span one scale factor change. Depositors withdraw correct STBL gains", async () => {
