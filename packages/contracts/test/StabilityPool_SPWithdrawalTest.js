  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      for (account of depositors) {
        await borrowerOperations.openTrove(th._100pct, dec(100, 18), account, account, { from: account, value: dec(2, 'ether') })
      ...
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '66666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '66666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '66666666666666666666'), 1000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '33333333333333333333'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '33333333333333333333'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '33333333333333333333'), 1000)
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing LUSD", async () => {
      ...
      // Defaulters open trove with 200% ICR
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: '500000000000000000' })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: '700000000000000000' })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(70, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      ...
      // Check depositors' compounded deposit is 0 LUSD and ETH Gain is 1.2 ETH
      const txA = await stabilityPool.withdrawFromSP(dec(100, 18), { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(100, 18), { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(100, 18), { from: carol })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '60000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '60000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '60000000000000000000'), 1000)

      // (0.5 + 0.7) * .995 / 3
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, dec(398, 15)), 1000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, dec(398, 15)), 1000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, dec(398, 15)), 1000)
    })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing LUSD", async () => {
      ...
      // Defaulters open trove with 200% ICR
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: '500000000000000000' })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: '600000000000000000' })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: '700000000000000000' })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(60, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(70, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      ...
      // Check depositors' compounded deposit is 80 LUSD and ETH Gain is 0.2 ETH*0.995
      const txA = await stabilityPool.withdrawFromSP(dec(100, 18), { from: alice })
      const txB = await stabilityPool.withdrawFromSP(dec(100, 18), { from: bob })
      const txC = await stabilityPool.withdrawFromSP(dec(100, 18), { from: carol })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '40000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '40000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '40000000000000000000'), 1000)

      // (0.5 + 0.6 + 0.7) * .995 / 3
      assert.isAtMost(th.getDifference(alice_ETHWithdrawn, dec(597, 15)), 1000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, dec(597, 15)), 1000)
      assert.isAtMost(th.getDifference(carol_ETHWithdrawn, dec(597, 15)), 1000)
    })
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), alice, alice, { from: alice, value: dec(2, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(th._100pct, dec(200, 18), bob, bob, { from: bob, value: dec(3, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(th._100pct, dec(300, 18), carol, carol, { from: carol, value: dec(4, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '66666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '133333333333333333333'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '200000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '50000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '100000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '150000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      Bob:  4560 LUSD
      Carol: 131 LUSD */
      await borrowerOperations.openTrove(th._100pct, '20000000000000000000', alice, alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP('20000000000000000000', ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(th._100pct, '4560000000000000000000', bob, bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP('4560000000000000000000', ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(th._100pct, '131000000000000000000', carol, carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP('131000000000000000000', ZERO_ADDRESS, { from: carol })


      /* Defaulters open troves
     
      Defaulter 1: 2070 LUSD & 21.6 ETH
      Defaulter 2: 50 LUSD & 0.5 ETH
      Defaulter 3: 467 LUSD & 5 ETH
      */
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(216, 17) })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: '500000000000000000' })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(5, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('2070000000000000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('467000000000000000000'), defaulter_3, defaulter_3, { from: defaulter_3 })
      ...
      // ()
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '9017193801740610000'), 10000000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '2055920186796860000000'), 1000000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '59062619401401000000'), 1000000000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), dennis, dennis, { from: dennis, value: dec(2, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '16666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '16666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '16666666666666666666'), 1000)

      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), '50000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), '0'), 1000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      Carol: 150 LUSD
      */
      await borrowerOperations.openTrove(th._100pct, dec(600, 18), alice, alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(600, 18), ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(th._100pct, dec(200, 18), bob, bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(th._100pct, dec(150, 18), carol, carol, { from: carol, value: dec(100, 'ether') })
      ...
      */
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: '2500000000000000000' })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: '500000000000000000' })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4, value: dec(4, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(250, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      //await borrowerOperations.withdrawLUSD(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(400, 18)), defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      await borrowerOperations.openTrove(th._100pct, dec(250, 18), dennis, dennis, { from: dennis, value: dec(100, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '178328173374613000000'), 1000000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '59442724458204300000'), 1000000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '44582043343653200000'), 1000000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), '117647058823529000000'), 1000000000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      Dennis: 400 LUSD
      */
      await borrowerOperations.openTrove(th._100pct, dec(200, 18), alice, alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(th._100pct, dec(250, 18), bob, bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(250, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(th._100pct, dec(125, 18), carol, carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(125, 18), ZERO_ADDRESS, { from: carol })

      await borrowerOperations.openTrove(th._100pct, dec(400, 18), dennis, dennis, { from: dennis, value: dec(100, 'ether') })
      ...
      */
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(2, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(3, 'ether') })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4, value: '500000000000000000' })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(200, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(300, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      //await borrowerOperations.withdrawLUSD(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '16722408026755900000'), 100000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '20903010033444800000'), 1000000000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '10451505016722400000'), 1000000000)
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 LUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      // Carol makes deposit
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), carol, carol, { from: carol, value: dec(2, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(alice)).toString(), '6666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '6666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '20000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // 2 Defaulters open trove with 200% ICR
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(200, 18)), defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(100, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '50000000000000000000'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), '50000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): Pool-emptying liquidation increases epoch by one, resets scaleFactor to 0, and resets P to 1e18", async () => {
      ...
      // Defaulter 1 liquidated. 100 LUSD fully offset, Pool remains non-zero
      await troveManager.liquidate(defaulter_1, { from: owner });
      ...
      // Defaulter 2 liquidated. 100 LUSD, empties pool
      await troveManager.liquidate(defaulter_2, { from: owner });
      ...
      // Defaulter 3 liquidated. 100 LUSD fully offset, Pool remains non-zero
      await troveManager.liquidate(defaulter_3, { from: owner });
      ...
      // Defaulter 4 liquidated. 200 LUSD, empties pool
      await troveManager.liquidate(defaulter_4, { from: owner });
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), carol, carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: carol })

      await borrowerOperations.openTrove(th._100pct, dec(200, 18), dennis, dennis, { from: dennis, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: dennis })

      await borrowerOperations.openTrove(th._100pct, dec(300, 18), erin, erin, { from: erin, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(300, 18), ZERO_ADDRESS, { from: erin })

      // Defaulter 2 liquidated. 100 LUSD offset
      await troveManager.liquidate(defaulter_2, { from: owner });

      // await borrowerOperations.openTrove(th._100pct, dec(1, 18), account, account, { from: flyn, value: dec(2, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '83333333333333333333'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), '166666666666666666666'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(erin)).toString(), '250000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(200, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(200, 18)), defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(200, 18)), defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      const depositors_1 = [alice, bob]
      for (account of depositors_1) {
        await borrowerOperations.openTrove(th._100pct, dec(100, 18), account, account, { from: account, value: dec(100, 'ether') })
        await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: account })
      }
      ...
      // await borrowerOperations.withdrawLUSD(th._100pct, dec(1, 18), whale, whale, { from: whale })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(erin)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(flyn)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(graham)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(harriet)).toString(), '0'), 1000)
    ...
    // A withdraws all
    // B deposits 100
    // L2 of 90 LUSD, should bring P slightly past boundary i.e. 1e-18 -> 1e-19
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 1 withdraws 'almost' 100 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999999999100'), defaulter_1, defaulter_1, { from: defaulter_1 })

      // Defaulter 2 withdraws 90 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: '500000000000000000' })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(90, 18)), defaulter_2, defaulter_2, { from: defaulter_2 })
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), bob, bob, { from: bob, value: dec(2, 'ether') })
      ...
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), '10000000000000000000'), 1000)
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 2 withdraws 540 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(3, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('540000000000000000000'), defaulter_2, defaulter_2, { from: defaulter_2 })
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), bob, bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(th._100pct, dec(200, 18), carol, carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: carol })

      await borrowerOperations.openTrove(th._100pct, dec(300, 18), dennis, dennis, { from: dennis, value: dec(100, 'ether') })
      ...
      */
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(bob)).toString(), dec(10, 18)), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(carol)).toString(), dec(20, 18)), 1000)
      assert.isAtMost(th.getDifference((await lusdToken.balanceOf(dennis)).toString(), dec(30, 18)), 1000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })

      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 1 and default 2 withdraw up to debt of 99.999999999 LUSD and 599.9999999 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })

      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(6, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('599999999994000000000'), defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      // Defaulters 1 withdraws 99.999999999 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), alice, alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: alice })
    ...
    C makes deposit 100
    L3 decreases P by(~1e-10)P. L3:  99.999999999000000000 LUSD, 1 ETH
    D makes deposit 100
    L4 decreases P by(~1e-10)P. L4:  99.999999999000000000 LUSD, 1 ETH
    expect A, B, C, D each withdraw ~1 Ether
    */
    it("withdrawFromSP(): Several deposits of 100 LUSD span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      // Whale opens Trove with 100 ETH
      await borrowerOperations.openTrove(th._100pct, 0, whale, whale, { from: whale, value: dec(100, 'ether') })

      // Defaulters 1-4 each withdraw 99.999999999 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_3, defaulter_3, { from: defaulter_3 })

      await borrowerOperations.openTrove(th._100pct, 0, defaulter_4, defaulter_4, { from: defaulter_4, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), dennis, dennis, { from: dennis, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: dennis })
    ...
    it("withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      // Defaulters 1-2 each withdraw 200 LUSD (inc gas comp)
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, dec(191, 18), defaulter_1, defaulter_1, { from: defaulter_1 })

      await borrowerOperations.openTrove(th._100pct, 0, defaulter_2, defaulter_2, { from: defaulter_2, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, dec(193, 18), defaulter_2, defaulter_2, { from: defaulter_2 })

      await borrowerOperations.openTrove(th._100pct, 0, defaulter_3, defaulter_3, { from: defaulter_3, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, dec(195, 18), defaulter_3, defaulter_3, { from: defaulter_3 })

      // price drops by 50%
      await priceFeed.setPrice(dec(100, 18));

      // A, B provide 10 LUSD 
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), A, A, { from: A, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), B, B, { from: B, value: dec(100, 'ether') })
      ...
      // C, D provide 10 LUSD 
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), C, C, { from: C, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), D, D, { from: D, value: dec(100, 'ether') })
      ...
      // E, F provide 10 LUSD 
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), E, E, { from: E, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(th._100pct, dec(100, 18), F, F, { from: F, value: dec(100, 'ether') })
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      // Whale opens Trove with 100 ETH
      await borrowerOperations.openTrove(th._100pct, 0, whale, whale, { from: whale, value: dec(1, 27) })

      // Defaulters 1-4 each withdraw up to debt of 99.999999999 LUSD
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount('99999999999000000000'), defaulter_1, defaulter_1, { from: defaulter_1 })
      ...
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_5, defaulter_5, { from: defaulter_5, value: dec(100, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, dec(1, 22), defaulter_5, defaulter_5, { from: defaulter_5 })

      await borrowerOperations.openTrove(th._100pct, 0, defaulter_6, defaulter_6, { from: defaulter_6, value: dec(100, 'ether') })
      await borrowerOperations.withdrawLUSD(th._100pct, dec(1, 22), defaulter_6, defaulter_6, { from: defaulter_6 })
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      // Whale opens Trove with 100 ETH
      await borrowerOperations.openTrove(th._100pct, 0, whale, whale, { from: whale, value: dec(1, 29) })
      ...
      // Defaulter opens trove with 200% ICR
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: dec(1, 27) })
      await borrowerOperations.withdrawLUSD(th._100pct, await getOpenTroveLUSDAmount(dec(1, 36)), defaulter_1, defaulter_1, { from: defaulter_1 })
    ...
    it("withdrawFromSP(): Tiny liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      // Defaulter opens trove with 50e-9 ETH 50 LUSD. 200% ICR
      await borrowerOperations.openTrove(th._100pct, 0, defaulter_1, defaulter_1, { from: defaulter_1, value: '50000000000' })
      ...
      aliceBalance = await lusdToken.balanceOf(alice)
      aliceExpectedBalance = toBN('999999999999999975000000000000000000')
      aliceBalDiff = aliceBalance.sub(aliceExpectedBalance).abs()

      assert.isTrue(aliceBalDiff.lte(toBN('1000000000000000000')))

      bobBalance = await lusdToken.balanceOf(bob)
      bobExpectedBalance = toBN('999999999999999975000000000000000000')
