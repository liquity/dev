...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_1, { from: defaulter_1 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing LUSD", async () => {
      ...
      // Defaulters open trove with 200% ICR
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: '100000000000000000' })
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: '200000000000000000' })
      await borrowerOperations.withdrawLUSD(0, dec(10, 18), defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing LUSD", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: '100000000000000000' })
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: '200000000000000000' })
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: '300000000000000000' })
      await borrowerOperations.withdrawLUSD(0, dec(10, 18), defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(0, dec(20, 18), defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      Bob:  4560 LUSD
      Carol: 131 LUSD */
      await borrowerOperations.openTrove(0, '20000000000000000000', alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP('20000000000000000000', ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(0, '4560000000000000000000', bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP('4560000000000000000000', ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(0, '131000000000000000000', carol, { from: carol, value: dec(100, 'ether') })
      ...
      */
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(22, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: '100000000000000000' })
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: dec(5, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '2100000000000000000000', defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(0, '457000000000000000000', defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 LUSD.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_4, { from: defaulter_4, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_4, { from: defaulter_4 })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      Carol: 150 LUSD
      */
      await borrowerOperations.openTrove(0, dec(600, 18), alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(600, 18), ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(0, dec(200, 18), bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(0, dec(150, 18), carol, { from: carol, value: dec(100, 'ether') })
      ...
      */
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: '2500000000000000000' })
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: '500000000000000000' })
      await borrowerOperations.openTrove(0, 0, defaulter_4, { from: defaulter_4, value: dec(4, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(0, dec(240, 18), defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(0, dec(40, 18), defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawLUSD(0, dec(390, 18), defaulter_4, { from: defaulter_4 })
      ...
      await borrowerOperations.openTrove(0, dec(250, 18), dennis, { from: dennis, value: dec(100, 'ether') })
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      Dennis: 400 LUSD
      */
      await borrowerOperations.openTrove(0, dec(200, 18), alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: alice })

      await borrowerOperations.openTrove(0, dec(250, 18), bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(250, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(0, dec(125, 18), carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(125, 18), ZERO_ADDRESS, { from: carol })

      await borrowerOperations.openTrove(0, dec(400, 18), dennis, { from: dennis, value: dec(100, 'ether') })
      ...
      */
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(2, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: dec(3, 'ether') })
      await borrowerOperations.openTrove(0, 0, defaulter_4, { from: defaulter_4, value: '500000000000000000' })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawLUSD(0, dec(190, 18), defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawLUSD(0, dec(290, 18), defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawLUSD(0, dec(40, 18), defaulter_4, { from: defaulter_4 })
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 LUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct LUSD deposit and ETH Gain", async () => {
      ...
      // Carol makes deposit
      await borrowerOperations.openTrove(0, dec(100, 18), carol, { from: carol, value: dec(2, 'ether') })
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // 2 Defaulters open trove with 200% ICR
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(190, 18), defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(90, 18), defaulter_2, { from: defaulter_2 })
      ...
      // await borrowerOperations.openTrove(0, dec(1, 18), account, { from: erin, value: dec(2, 'ether') })
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openTrove(0, dec(100, 18), carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: carol })

      await borrowerOperations.openTrove(0, dec(200, 18), dennis, { from: dennis, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: dennis })

      await borrowerOperations.openTrove(0, dec(300, 18), erin, { from: erin, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(300, 18), ZERO_ADDRESS, { from: erin })

      // Defaulter 2 liquidated. 100 LUSD offset
      await troveManager.liquidate(defaulter_2, { from: owner });

      // await borrowerOperations.openTrove(0, dec(1, 18), account, { from: flyn, value: dec(2, 'ether') })
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(190, 18), defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(190, 18), defaulter_3, { from: defaulter_3 })
      await borrowerOperations.openTrove(0, 0, defaulter_4, { from: defaulter_4, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(190, 18), defaulter_4, { from: defaulter_4 })
      ...
      const depositors_1 = [alice, bob]
      for (account of depositors_1) {
        await borrowerOperations.openTrove(0, dec(100, 18), account, { from: account, value: dec(100, 'ether') })
        await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: account })
      }
      ...
      // await borrowerOperations.withdrawLUSD(0, dec(1, 18), whale, { from: whale })
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '89999999999999999000', defaulter_1, { from: defaulter_1 })

      // Defaulter 2 withdraws 80 LUSD
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: '500000000000000000' })
      await borrowerOperations.withdrawLUSD(0, dec(80, 18), defaulter_2, { from: defaulter_2 })
      ...
      await borrowerOperations.openTrove(0, dec(100, 18), bob, { from: bob, value: dec(2, 'ether') })
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(3, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '530000000000000000000', defaulter_2, { from: defaulter_2 })
      ...
      await borrowerOperations.openTrove(0, dec(100, 18), bob, { from: bob, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: bob })

      await borrowerOperations.openTrove(0, dec(200, 18), carol, { from: carol, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(200, 18), ZERO_ADDRESS, { from: carol })

      await borrowerOperations.openTrove(0, dec(300, 18), dennis, { from: dennis, value: dec(100, 'ether') })
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '89999999999000000000', defaulter_1, { from: defaulter_1 })

      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '89999999999000000000', defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(6, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '589999999994000000000', defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      await borrowerOperations.openTrove(0, dec(100, 18), alice, { from: alice, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: alice })
    ...
    */
    it("withdrawFromSP(): Several deposits of 100 LUSD span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '89999999999000000000', defaulter_3, { from: defaulter_3 })

      await borrowerOperations.openTrove(0, 0, defaulter_4, { from: defaulter_4, value: dec(1, 'ether') })
      await borrowerOperations.withdrawLUSD(0, '89999999999000000000', defaulter_4, { from: defaulter_4 })
      ...
      await borrowerOperations.openTrove(0, dec(100, 18), dennis, { from: dennis, value: dec(100, 'ether') })
      await stabilityPool.provideToSP(dec(100, 18), ZERO_ADDRESS, { from: dennis })
    ...
    it("withdrawFromSP(): 2 depositors can withdraw after each receiving half of a pool-emptying liquidation", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(191, 18), defaulter_1, { from: defaulter_1 })

      await borrowerOperations.openTrove(0, 0, defaulter_2, { from: defaulter_2, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(193, 18), defaulter_2, { from: defaulter_2 })

      await borrowerOperations.openTrove(0, 0, defaulter_3, { from: defaulter_3, value: dec(2, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(195, 18), defaulter_3, { from: defaulter_3 })
      ...
      // C, D provide 10 LUSD 
      await borrowerOperations.openTrove(0, dec(100, 18), C, { from: C, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(0, dec(100, 18), D, { from: D, value: dec(100, 'ether') })
      ...
      // E, F provide 10 LUSD 
      await borrowerOperations.openTrove(0, dec(100, 18), E, { from: E, value: dec(100, 'ether') })
      await borrowerOperations.openTrove(0, dec(100, 18), F, { from: F, value: dec(100, 'ether') })
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      // Whale opens Trove with 100 ETH
      await borrowerOperations.openTrove(0, 0, whale, { from: whale, value: dec(1, 27) })
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_5, { from: defaulter_5, value: dec(100, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(1, 22), defaulter_5, { from: defaulter_5 })

      await borrowerOperations.openTrove(0, 0, defaulter_6, { from: defaulter_6, value: dec(100, 'ether') })
      await borrowerOperations.withdrawLUSD(0, dec(1, 22), defaulter_6, { from: defaulter_6 })
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      // Whale opens Trove with 100 ETH
      await borrowerOperations.openTrove(0, 0, whale, { from: whale, value: dec(1, 29) })
      ...
      for (account of depositors) {
        await borrowerOperations.openTrove(0, dec(1, 36), account, { from: account, value: dec(2, 27) })
        await stabilityPool.provideToSP(dec(1, 36), ZERO_ADDRESS, { from: account })
      }

      // Defaulter opens trove with 200% ICR
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: dec(1, 27) })
      await borrowerOperations.withdrawLUSD(0, await th.getActualDebtFromComposite(dec(1, 36), contracts), defaulter_1, { from: defaulter_1 })
    ...
    it("withdrawFromSP(): Tiny liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, defaulter_1, { from: defaulter_1, value: '20000000000' })
      await borrowerOperations.withdrawLUSD(0, dec(10, 18), defaulter_1, { from: defaulter_1 })
