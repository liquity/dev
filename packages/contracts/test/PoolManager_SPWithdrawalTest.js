  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      for (account of depositors) {
        await borrowerOperations.openLoan(mv._100e18, account, account, { from: account, value: mv._2_Ether })
        await poolManager.provideToSP(mv._100e18, { from: account })
      }

      // Defaulter opens loan with 200% ICR
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._1_Ether })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_1, defaulter_1, { from: defaulter_1 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._1_Ether })
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._1_Ether })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._1_Ether })
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._1_Ether })
      await borrowerOperations.openLoan(0,  defaulter_3, defaulter_3, { from: defaulter_3, value: mv._1_Ether })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_3, defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing CLV", async () => {
      ...
      await borrowerOperations.withdrawCLV(mv._10e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._20e18, defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing CLV", async () => {
      ...
      await borrowerOperations.withdrawCLV(mv._10e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._20e18, defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawCLV(mv._30e18, defaulter_3, defaulter_3, { from: defaulter_3 })
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      await borrowerOperations.openLoan(mv._300e18, carol, carol, { from: carol, value: mv._2_Ether })
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      Bob:  4560 CLV
      Carol: 131 CLV */
      await borrowerOperations.openLoan('20000000000000000000', alice, alice, { from: alice, value: mv._100_Ether })
      await poolManager.provideToSP('20000000000000000000', { from: alice })

      await borrowerOperations.openLoan('4560000000000000000000', bob, bob, { from: bob, value: mv._100_Ether })
      await poolManager.provideToSP('4560000000000000000000', { from: bob })

      await borrowerOperations.openLoan('131000000000000000000', carol, carol, { from: carol, value: mv._100_Ether })
      ...
      */
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._22_Ether })
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: '100000000000000000' })
      await borrowerOperations.openLoan(0,  defaulter_3, defaulter_3, { from: defaulter_3, value: mv._5_Ether })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 CLV.  A, B, C, D withdraw correct CLV deposit and ETH Gain", async () => {
      ...
      await borrowerOperations.openLoan(mv._100e18, dennis, dennis, { from: dennis, value: mv._2_Ether })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 CLV.  A, B, C, D withdraw correct CLV deposit and ETH Gain", async () => {
      ...
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._1_Ether })
      await borrowerOperations.openLoan(0,  defaulter_3, defaulter_3, { from: defaulter_3, value: mv._1_Ether })
      await borrowerOperations.openLoan(0,  defaulter_4, defaulter_4, { from: defaulter_4, value: mv._1_Ether })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_4, defaulter_4, { from: defaulter_4 })
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct CLV deposit and ETH Gain", async () => {
      ...
      Carol: 150 CLV
      */
      await borrowerOperations.openLoan(mv._600e18, alice, alice, { from: alice, value: mv._100_Ether })
      await poolManager.provideToSP(mv._600e18, { from: alice })

      await borrowerOperations.openLoan(mv._200e18, bob, bob, { from: bob, value: mv._100_Ether })
      await poolManager.provideToSP(mv._200e18, { from: bob })

      await borrowerOperations.openLoan(mv._150e18, carol, carol, { from: carol, value: mv._100_Ether })
      ...
      */
      ...
      await borrowerOperations.openLoan(0,  defaulter_4, defaulter_4, { from: defaulter_4, value: mv._4_Ether })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._250e18, defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawCLV(mv._50e18, defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawCLV(mv._400e18, defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      await borrowerOperations.openLoan(mv._250e18, dennis, dennis, { from: dennis, value: mv._100_Ether })
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct CLV deposit and ETH Gain", async () => {
      ...
      Dennis: 400 CLV
      */
      await borrowerOperations.openLoan(mv._200e18, alice, alice, { from: alice, value: mv._100_Ether })
      await poolManager.provideToSP(mv._200e18, { from: alice })

      await borrowerOperations.openLoan(mv._250e18, bob, bob, { from: bob, value: mv._100_Ether })
      await poolManager.provideToSP(mv._250e18, { from: bob })

      await borrowerOperations.openLoan(mv._125e18, carol, carol, { from: carol, value: mv._100_Ether })
      await poolManager.provideToSP(mv._125e18, { from: carol })

      await borrowerOperations.openLoan(mv._400e18, dennis, dennis, { from: dennis, value: mv._100_Ether })
      ...
      */
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._1_Ether })
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._2_Ether })
      await borrowerOperations.openLoan(0,  defaulter_3, defaulter_3, { from: defaulter_3, value: mv._3_Ether })
      await borrowerOperations.openLoan(0,  defaulter_4, defaulter_4, { from: defaulter_4, value: '500000000000000000' })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.withdrawCLV(mv._200e18, defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.withdrawCLV(mv._300e18, defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.withdrawCLV(mv._50e18, defaulter_4, defaulter_4, { from: defaulter_4 })
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 CLV. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct CLV deposit and ETH Gain", async () => {
      ...
      // Carol makes deposit
      await borrowerOperations.openLoan(mv._100e18, carol, carol, { from: carol, value: mv._2_Ether })
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      // 2 Defaulters open loan with 200% ICR
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._2_Ether })
      await borrowerOperations.withdrawCLV(mv._200e18, defaulter_1, defaulter_1, { from: defaulter_1 })
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._1_Ether })
      await borrowerOperations.withdrawCLV(mv._100e18, defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openLoan(mv._100e18, carol, carol, { from: carol, value: mv._100_Ether })
      await poolManager.provideToSP(mv._100e18, { from: carol })

      await borrowerOperations.openLoan(mv._200e18, dennis, dennis, { from: dennis, value: mv._100_Ether })
      await poolManager.provideToSP(mv._200e18, { from: dennis })

      await borrowerOperations.openLoan(mv._300e18, erin, erin, { from: erin, value: mv._100_Ether })
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._2_Ether })
      await borrowerOperations.withdrawCLV(mv._200e18, defaulter_2, defaulter_2, { from: defaulter_2 })
      await borrowerOperations.openLoan(0,  defaulter_3, defaulter_3, { from: defaulter_3, value: mv._2_Ether })
      await borrowerOperations.withdrawCLV(mv._200e18, defaulter_3, defaulter_3, { from: defaulter_3 })
      await borrowerOperations.openLoan(0,  defaulter_4, defaulter_4, { from: defaulter_4, value: mv._2_Ether })
      await borrowerOperations.withdrawCLV(mv._200e18, defaulter_4, defaulter_4, { from: defaulter_4 })
      ...
      const depositors_1 = [alice, bob]
      for (account of depositors_1) {
        await borrowerOperations.openLoan(mv._100e18, account, account, { from: account, value: mv._100_Ether })
        await poolManager.provideToSP(mv._100e18, { from: account })
      }
      ...
      // await borrowerOperations.withdrawCLV(mv._1e18, whale, whale, { from: whale })
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.withdrawCLV(mv._90e18, defaulter_2, defaulter_2, { from: defaulter_2 })
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._3_Ether })
      ...
      await borrowerOperations.openLoan(mv._100e18, bob, bob, { from: bob, value: mv._100_Ether })
      await poolManager.provideToSP(mv._100e18, { from: bob })

      await borrowerOperations.openLoan(mv._200e18, carol, carol, { from: carol, value: mv._100_Ether })
      await poolManager.provideToSP(mv._200e18, { from: carol })

      await borrowerOperations.openLoan(mv._300e18, dennis, dennis, { from: dennis, value: mv._100_Ether })
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openLoan(0,  defaulter_2, defaulter_2, { from: defaulter_2, value: mv._6_Ether })
    ...
    it("withdrawFromSP(): Deposit that decreases to less than 1e-9 of it's original value is reduced to 0", async () => {
      ...
      await borrowerOperations.openLoan(mv._100e18, alice, alice, { from: alice, value: mv._100_Ether })
      await poolManager.provideToSP(mv._100e18, { from: alice })
    ...
    */
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      await borrowerOperations.openLoan(mv._100e18, dennis, dennis, { from: dennis, value: mv._100_Ether })
      await poolManager.provideToSP(mv._100e18, { from: dennis })
   ...
   it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
    // Whale opens CDP with 100 ETH
    await borrowerOperations.openLoan(0,  whale, whale, { from: whale, value: mv._1billion_Ether })
    ...
    await borrowerOperations.openLoan(0,  defaulter_5, defaulter_5, { from: defaulter_5, value: mv._100_Ether })
    await borrowerOperations.withdrawCLV(mv._1e22, defaulter_5, defaulter_5, { from: defaulter_5 })

    await borrowerOperations.openLoan(0,  defaulter_6, defaulter_6, { from: defaulter_6, value: mv._100_Ether })
    await borrowerOperations.withdrawCLV(mv._1e22, defaulter_6, defaulter_6, { from: defaulter_6 })
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      // Whale opens CDP with 100 ETH
      await borrowerOperations.openLoan(0,  whale, whale, { from: whale, value: mv._100billion_Ether })
      ...
      for (account of depositors) {
        await borrowerOperations.openLoan(mv._1e36, account, account, { from: account, value: mv._1billion_Ether })
        await poolManager.provideToSP(mv._1e36, { from: account })
      }

      // Defaulter opens loan with 200% ICR
      await borrowerOperations.openLoan(0,  defaulter_1, defaulter_1, { from: defaulter_1, value: mv._1billion_Ether })
      await borrowerOperations.withdrawCLV(mv._1e36, defaulter_1, defaulter_1, { from: defaulter_1 })
    ...
    it("withdrawFromSP(): Tiny liquidated coll/debt, large deposits and ETH price", async () => {
      ...
      await borrowerOperations.withdrawCLV(mv._20e18, defaulter_1, defaulter_1, { from: defaulter_1 })
