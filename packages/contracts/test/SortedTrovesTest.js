...
contract('SortedTroves', async accounts => {
  ...
  describe('SortedTroves', () => {
    ...
    it('contains(): returns true for addresses that have opened troves', async () => {
      ...
      await borrowerOperations.openTrove(0, '98908089089', carol, { from: carol, value: '23082308092385098009809' })
    ...
    it('contains(): returns true for addresses that opened, closed and then re-opened a trove', async () => {
      ...
      await borrowerOperations.openTrove(0, '234234', alice, { from: alice, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, '9999', bob, { from: bob, value: dec(5, 'ether') })
      await borrowerOperations.openTrove(0, '1', carol, { from: carol, value: '23082308092385098009809' })
    ...
    it("Finds the correct insert position given two addresses that loosely bound the correct position", async () => { 
      ...
      await borrowerOperations.openTrove(0, 0, whale, { from: whale, value: dec(5000, 'ether') }) //  Highest NICR (50,000%)
      await borrowerOperations.openTrove(0, dec(90, 18), A, { from: A, value: dec(10, 'ether') }) //  |  NICR = 1,000%
      await borrowerOperations.openTrove(0, dec(190, 18), B, { from: B, value: dec(10, 'ether') }) //  | NICR = 500%
      await borrowerOperations.openTrove(0, dec(390, 18), C, { from: C, value: dec(10, 'ether') }) //  | NICR = 250%
      await borrowerOperations.openTrove(0, dec(590, 18), D, { from: D, value: dec(10, 'ether') }) //  | NICR = 166%
      await borrowerOperations.openTrove(0, dec(790, 18), E, { from: E, value: dec(10, 'ether') }) //  Lowest NICR (125%)
    ...
    it("stays ordered after troves with 'infinite' ICR receive a redistribution", async () => {
      ...
      await borrowerOperations.openTrove(0, 0, A, { from: A, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, 0, B, { from: B, value: dec(37, 'ether') })
      await borrowerOperations.openTrove(0, 0, C, { from: C, value: dec(5, 'ether') })
      await borrowerOperations.openTrove(0, 0, D, { from: D, value: dec(4, 'ether') })
      await borrowerOperations.openTrove(0, 0, E, { from: E, value: dec(19, 'ether') })

      // Make some troves with non-zero debt, in random order
      await borrowerOperations.openTrove(0, dec(5, 19), F, { from: F, value: dec(1, 'ether') })
      await borrowerOperations.openTrove(0, dec(3, 18), G, { from: G, value: dec(37, 'ether') })
      await borrowerOperations.openTrove(0, dec(2, 20), H, { from: H, value: dec(5, 'ether') })
      await borrowerOperations.openTrove(0, dec(17, 18), I, { from: I, value: dec(4, 'ether') })
      await borrowerOperations.openTrove(0, dec(5, 21), J, { from: J, value: dec(1345, 'ether') })
