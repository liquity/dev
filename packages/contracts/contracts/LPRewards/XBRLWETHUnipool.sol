 ...
 */
contract XBRLWETHUnipool is LPTokenWrapper, Ownable, CheckContract, IUnipool {
    string constant public NAME = "XBRLWETHUnipool";
        ...
        onlyOwner
    {
        ...
        _notifyRewardAmount(stblToken.getXbrlWethLpRewardsEntitlement(), _duration);
