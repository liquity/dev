...
export const LiquityLogoWithText: React.FC<React.SVGProps<SVGSVGElement>> = ({
  children,
  ...svgProps
}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 156 38" {...svgProps}>
    {children}
    {liquityText}
    {liquityLogo}
  </svg>
...
export const LiquityLogo: React.FC<React.SVGProps<SVGSVGElement>> = ({ children, ...svgProps }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 38" {...svgProps}>
    {children}
    {liquityLogo}
  </svg>
);
