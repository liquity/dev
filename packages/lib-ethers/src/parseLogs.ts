...
import { _StabilioContracts, _TypedStabilioContract } from "./contracts";

type ContractLookup = {
  [name: string]: _TypedStabilioContract;
};
...
export const logsToString = (receipt: TransactionReceipt, contracts: _StabilioContracts): string => {
