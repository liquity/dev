...
const { EthersLiquity } = require("@fluidity/lib-ethers");
...
Liquity's [Dev UI](https://github.com/liquity/liquity/tree/master/packages/dev-frontend) itself contains many examples of `@fluidity/lib-ethers` use.
