...
|  [approveXbrlWethUniTokens(allowance)](./lib-base.sendablestabilio.approvexbrlwethunitokens.md) | Allow the liquidity mining contract to use Uniswap ETH/XBRL LP tokens for [staking](./lib-base.transactablestabilio.stakexbrlwethunitokens.md)<!-- -->. |
...
|  [stakeXbrlWethUniTokens(amount)](./lib-base.sendablestabilio.stakexbrlwethunitokens.md) | Stake Uniswap ETH/XBRL LP tokens to participate in liquidity mining and earn STBL. |
...
|  [unstakeXbrlWethUniTokens(amount)](./lib-base.sendablestabilio.unstakexbrlwethunitokens.md) | Withdraw Uniswap ETH/XBRL LP tokens from liquidity mining. |
