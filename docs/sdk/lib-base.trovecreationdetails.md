...
[Home](./index.md) &gt; [@stabilio/lib-base](./lib-base.md) &gt; [TroveCreationDetails](./lib-base.trovecreationdetails.md)

## TroveCreationDetails interface

Details of an [openTrove()](./lib-base.transactablestabilio.opentrove.md) transaction.
...
|  --- | --- | --- |
|  [fee](./lib-base.trovecreationdetails.fee.md) | [Decimal](./lib-base.decimal.md) | Amount of XBRL added to the Trove's debt as borrowing fee. |
