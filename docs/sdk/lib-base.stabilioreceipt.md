...
[Home](./index.md) &gt; [@stabilio/lib-base](./lib-base.md) &gt; [StabilioReceipt](./lib-base.stabilioreceipt.md)

## StabilioReceipt type
...
```typescript
export declare type StabilioReceipt<R = unknown, D = unknown> = PendingReceipt | MinedReceipt<R, D>;
```
