...
[Home](./index.md) &gt; [@stabilio/lib-base](./lib-base.md) &gt; [Trove](./lib-base.trove.md) &gt; [create](./lib-base.trove.create.md)

## Trove.create() method

Calculate the result of an [openTrove()](./lib-base.transactablestabilio.opentrove.md) transaction.
