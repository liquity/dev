...
| [getLiquidityMiningStake(address)](./lib-base.readableliquity.getliquidityminingstake.md)                      | Get the amount of Uniswap ETH/1USD LP tokens currently staked by an address in liquidity mining. |
...
| [get1USDBalance(address)](./lib-base.readableliquity.getlusdbalance.md)                                        | Get the amount of 1USD held by an address.                                                       |
| [get1USDInStabilityPool()](./lib-base.readableliquity.getlusdinstabilitypool.md)                               | Get the total amount of 1USD currently deposited in the Stability Pool.                          |
...
| [getTotalStakedUniTokens()](./lib-base.readableliquity.gettotalstakedunitokens.md)                             | Get the total amount of Uniswap ETH/1USD LP tokens currently staked in liquidity mining.         |
...
| [getUniTokenAllowance(address)](./lib-base.readableliquity.getunitokenallowance.md)                            | Get the liquidity mining contract's allowance of a holder's Uniswap ETH/1USD LP tokens.          |
| [getUniTokenBalance(address)](./lib-base.readableliquity.getunitokenbalance.md)                                | Get the amount of Uniswap ETH/1USD LP tokens held by an address.                                 |
